...
<body>
    ...
    <div class="main">
        <div class="container">
            <h1>
                <p> Добро пожаловать на сайт по созданию заметок</br></p>
            </h1>
            <h4>
                У нас вы можете делать множество пометок и не пытаться держать всю информацию в голове</br>
                Для того, чтобы начать, вам нужно зарегистрироваться или войти в аккаунт.
